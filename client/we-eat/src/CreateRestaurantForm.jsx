            ...
            <>
                <div className="formcontainer">
                    <Form onSubmit={() => alert("Your Restaurant has been created")}>
                        ...
                        <FormField className="formtext"  control={Select} fluid  label='Cuisine'  options={cuisine_options}  />
                        <FormField className="formtext"  control={Select}  fluid  label='Rating'  options={star_rating_options}  />
